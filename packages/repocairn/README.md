...
| Go, Rust, Java, Kotlin, C# | ✅ tree-sitter AST | ❌ symbols only | Import specs are module/package paths (`go.mod`, crate tree, classpath, `.csproj`), not file paths — resolving them needs build-manifest awareness repocairn doesn't have yet |
